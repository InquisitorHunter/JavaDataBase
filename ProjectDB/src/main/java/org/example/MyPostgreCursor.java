...
public class MyPostgreCursor implements ICursor {
    ...
    public MyPostgreCursor(Connection connection, String query) throws SQLException {
    ...
    public MyPostgreCursor(ResultSet resultSet) throws SQLException {
        if (resultSet == null) {
    ...
    public String getValue(int column) {
        try {
            if (resultSet != null && column > 0 && resultSet.getRow() > 0) {
